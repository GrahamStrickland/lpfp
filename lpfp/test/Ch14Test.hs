...
testCh14Newton2 =
    TestLabel "Ch14.Newton2 tests" $
        TestList
            ...
            , TestCase $ assertEqual "positionFtv 0.1 70 0 [const 100,fAirT 2 1.225 0.6] 0" 0.0 (Newton2.positionFtv 0.1 70 0 0 [const 100, Newton2.fAirT 2 1.225 0.6] 0)
            , TestCase $ assertEqual "positionFtv 0.1 70 0 [const 100,fAirT 2 1.225 0.6] 1" 0.6417028011495182 (Newton2.positionFtv 0.1 70 0 0 [const 100, Newton2.fAirT 2 1.225 0.6] 1)
            , TestCase $ assertEqual "positionFtv 0.1 70 0 [const 100,fAirT 2 1.225 0.6] 2" 2.691369821799467 (Newton2.positionFtv 0.1 70 0 0 [const 100, Newton2.fAirT 2 1.225 0.6] 2)
            ]
